...
namespace Sketchfab
{
    public class SketchfabUI
    {
        ...
        public void displayFooter(string latestVersion)
        {
            displayVersionInfo(latestVersion);
        }

        public void displayVersionInfo(string latestVersion)
        {
            ...
            else if (latestVersion == SketchfabPlugin.VERSION)
            {
                showUpToDate(SketchfabPlugin.VERSION);
            }
            else
            {
                //showOutdatedVersionWarning(latestVersion);
            }
        }
    }
