...
namespace Sketchfab
{
    public class SketchfabPlugin : MonoBehaviour
    {
        ...
        public static void onVersionCheckFailure()
        {
        ...
        public static void displayHeader()
        {
            ...
            GUILayout.Label(Resources.Load("SketchfabGrey") as Texture2D, GUILayout.Height(40));
            GUILayout.FlexibleSpace();
        ...
        public static void displayFooter()
        {
            ...
            GUILayout.Label("Sketchfab plugin for Unity " + VERSION + " " + versionCaption, EditorStyles.centeredGreyMiniLabel);
            GUILayout.FlexibleSpace();
            ...
            if (GUILayout.Button("<color=" + SketchfabUI.CLICKABLE_COLOR + "> Report an isse </color>", _ui.SketchfabLabel, GUILayout.Height(20)))
            {
